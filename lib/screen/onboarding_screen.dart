  ...
  Widget build(BuildContext context) {
    ...
    final list = [
      ...
      Onboard(
          ...
          subtitle:
          'Hi! You can ask me anything, I am here to help!',
          lottie: 'ai_ask_me'),

      //onboarding 2
      Onboard(
        title: 'Crafting Reality from Imagination.',
        lottie: 'ai_play',
        subtitle:
        'Share your vision, and I’ll craft it into something truly exceptional.',
      ),
    ];
